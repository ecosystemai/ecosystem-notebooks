...
def update_properties_key(auth, key, value):
...
def put_financial_wellness(auth, document):
...
def estore_recommendations(auth, msisdn, payment_method, campaign_id, sub_campaign_id, channel_name, number_of_offers, user_id, params):
...
def put_estore_recommendations(auth, document):
...
def connect_u(auth, msisdn, payment_method, campaign_id, sub_campaign_id, channel_name, number_of_offers, user_id, params):
...
def put_connect_u(auth, document):
...
def just_for_u(auth, msisdn, payment_method, campaign_id, sub_campaign_id, channel_name, number_of_offers, user_id, params):
...
def put_just_for_u(auth, document):
...
def estore_recommender_non_gsm(auth, msisdn, payment_method, campaign_id, sub_campaign_id, channel_name, number_of_offers, user_id, params):
...
def put_estore_recommender_non_gsm(auth, document):
...
def gift_recommendations_free(auth, msisdn, payment_method, campaign_id, sub_campaign_id, channel_name, number_of_offers, user_id, params, transaction_id):
...
def gift_recommendations_purchased(auth, msisdn, payment_method, campaign_id, sub_campaign_id, channel_name, number_of_offers, user_id, params, transaction_id):
...
def put_gift_recommendations(auth, document):
